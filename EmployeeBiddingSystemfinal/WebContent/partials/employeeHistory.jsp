...
<div style="padding-left: 10em;">Employee ID :&nbsp;&nbsp;&nbsp;<input type="text" name="bidEmpId"/>
<input type="submit" class="input-rounded-button" style="width: inherit;" name="submit" value="Get Employee Bids"/></div><br/><br/>
<%if(request.getAttribute("myBids")!=null && request.getAttribute("myBids")!=""){
List<Bids> bids = (List<Bids>)request.getAttribute("empBids");
int total = 0;
%>
